...
const Carousel2 = () => {
    ...
    },
    {
      ...
      details: (
        <div className="entity-details text-left visible">
          ...
          >
            <h3 className="title no_focus">
              <span>SWCE 2023: The Ahsoka Trailer Is Here</span>
            </h3>
          </a>
        </div>
      ),
      ...
      details: (
        <div className="entity-details text-left visible">
          ...
          >
            <h3 className="title no_focus">
              <span>
                Rosario Dawsn an Natasha Liu Bordizzo Take the Stage at SWCA
                2022 | Star Wars Celebration Live!
              </span>
            </h3>
          </a>
        </div>
        ...
        <div className="entity-details text-left visible">
          ...
          >
            <h3 className="title no_focus">
              <span>
                {" "}
                SWCE 2023: 10 Things We Learned from the Ahsoka Panel{" "}
              </span>
            </h3>
          </a>
        </div>
  ...
  return (
    <div className="aspect">
      ...
      <div
        class="content-overlay   content-left content-middle  text-center   text-light mt-5"
          ...
          <div class="content-details" style={{ maxWidth: "36%" }}>
            <div class="content-title ">
              <img
                ...
                width="600"
                height="193"
                data-src="https://lumiere-a.akamaihd.net/v1/images/ahsoka-logo-desktop_083fbe8d.png?region=0,0,600,193"
                alt="Ahsoka Logo"
                tabindex="0"
                style={{ width: "400px" }}
                data-width="600"
                data-height="193"
                data-aspect_ratio="0.3217"
                data-orientation="landscape"
                data-legacy="true"
                src="https://lumiere-a.akamaihd.net/v1/images/ahsoka-logo-desktop_083fbe8d.png?region=0,0,600,193"
              ></img>
            </div>
            <div
              class="content-description mt-2"
              tabindex="0"
              style={{
                fontSize: "20px",
                fontWeight: "bold",
            ...
            >
              <p style={{ marginBottom: "0em" }}>
                Ahsoka Tano investigates an emerging
              </p>
              <p style={{ marginBottom: "0em" }}>
                {" "}
                threat to the galaxy. Original series{" "}
              </p>
              <p style={{ marginBottom: "0em" }}>
                {" "}
                streaming August 23, only on Disney+.
              </p>
            </div>
