      ...
      <div class="horizontal-list">
        <ul class="mt-2">
          ...
          <li class="youtube social-icon">
            <a
              className="navbar-brand text-white navbar-brand-divider"
              href="https://twitter.com/i/flow/login?redirect_after_login=%2Fstarwars"
            >
      ...
      <div class="menu-primary mt-2">
        <nav role="navigation" aria-label="Primary footer menu">
          <ul class="horizontal">
            ...
            <li>
              <a
                href="https://support.starwars.com/"
                target="_blank"
                rel="noopener noreferrer"
                class="link_footer aw-independent"
              >
            ...
            <li>
              <a
                href="http://preferences-mgr.truste.com/?type=starwars&affiliateId=115"
                target="_blank"
                rel="noopener noreferrer"
                class="link_footer aw-independent"
              >
