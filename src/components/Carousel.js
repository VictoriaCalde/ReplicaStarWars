...
const CarouselComponent = () => {
  ...
  <div className="carousel-overlay overlay-image4">
    <div className="content-details" style={{ maxWidth: "36%" }}>
      ...
      <div className="content-description" tabIndex="0">
        <p><p>Go behind the scenes in the all-new</p> <p>special <i>Disney Gallery: The Mandalorian</i>,</p> <p>streaming June 28 on Disney+.</p></p>
      </div>
      <p className="cta-links-container text-center" data-cta-type="button">
        <span className="cta-item" data-title="Watch Clip">
          <span className="btn-container">
            <a href="https://youtu.be/KVnTWuVPPkM" className="button large blue cta-link ada-el-focus youtube-url" role="button" data-youtube-id="KVnTWuVPPkM" tabIndex="0">
              Watch Clip
            </a>
          </span>
        </span>
